   ...
   <body>
    <div class="maincont">
     ...
     <form action="" method="post" class="reg-login">
      <div class="lrBox"><input type="hidden" id="add_id" value="{{$addInfo['add_id']}}">
       ...
       <div class="lrList">
        ...
        <option value="{{$v['id']}}" @if($addInfo['province']==$v['id']) selected="selected" @endif>{{$v['name']}}</option>
        @endforeach
        </select>
       </div> 
       <div class="lrList">
        <select id="city" class="changearea">
         <option value="" selected="selected">--直辖市--</option>
           @foreach($cityInfo as $k=>$v)
            <option value="{{$v['id']}}" @if($addInfo['city']==$v['id']) selected="selected" @endif>{{$v['name']}}</option>
          @endforeach
        </select>
       </div>
       <div class="lrList">
        <select id="area" class="changearea">
         ...
         @foreach($areaInfos as $k=>$v)
            <option value="{{$v['id']}}" @if($addInfo['area']==$v['id']) selected="selected" @endif>{{$v['name']}}</option>
          @endforeach
        </select>
        </div>
